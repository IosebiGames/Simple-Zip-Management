...
add("/content file path"); (adds file content inside of Zip file after its been created)
extractZip("/content file path", "/destionationPath"); (extracts specific content from the Zip file into certain package)
removeFile("/content file path"); (removes specific content from the Zip file)
