...
Note ❗️: setPassword method is malfunctioning for some reason, performing it results nothing. everything is working but no password is setting at all.
